...
// 搞定banner轮播
(function() {
    var silderContainer = $('.banner .slider-container');
    var dots = $('.banner .dots');
    createSlider(silderContainer, 2000, function(index) {
        // console.log(index);
        var ac = dots.querySelector('.active');
        ac &&  ac.classList.remove('active');
        dots.children[index].classList.add('active'); // H5 classList 添加类样式
    })
})()